    ...
    <section id="section3" className="w-full bg-[#002244] py-24 px-6 relative overflow-hidden scroll-mt-16 font-['Montserrat',sans-serif]">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] via-[#f1d570] to-[#D4AF37] mb-6 uppercase tracking-wide">
          ...
          <p className="mt-4 text-white/80 font-medium max-w-3xl mx-auto text-lg leading-relaxed">
            Nghiên cứu 6 đặc điểm cốt lõi của cộng đồng các dân tộc và định hướng chính sách toàn diện của Đảng & Nhà nước.
          </p>
        </motion.div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <motion.button
                          ...
                          transition={{ type: "spring", stiffness: 40, damping: 15, mass: 1 }}
                          className={`absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 md:w-28 md:h-28 rounded-full flex flex-col items-center justify-center border-4 transition-all duration-300 z-30 shadow-2xl focus:outline-none ${
                            activePolicy === idx 
